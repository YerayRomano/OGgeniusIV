...
<body>
	...
	%>
		<form action="" method="post" id="<%= i %>"><input type="hidden" name="tema" value="<%= i %>"/></form>
		<td><img src="temas/<%= i %>.jpg" width="320" height="240" onclick="document.getElementById('<%= i %>').submit()"/><br/><%= temaList.get(i).getNombre() %></td>
		<% if(i % 4 == 0 && i != 0) { %>
		</tr>
